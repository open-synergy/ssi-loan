...
class TestLoanInSchedule(YamlTransactionCase):
    """Cover ``loan.payment_schedule_in`` action methods and computes.
    ...
    def test_loan_in_schedule(self):
        """Run the ``test_data_loan_in_schedule.yaml`` scenario."""
        self.run_yaml_scenario("test_data_loan_in_schedule.yaml")
