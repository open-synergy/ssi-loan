...
3. Fill in the required fields:
   - **Name**: the name of the collateral type (e.g. Land, Vehicle, Equipment).
...
- The record can now be selected as **Type** on loan collateral lines.
