...
3. Fill in the required fields:
   ...
   - **Partner**: select the lender partner (the third party the company borrows this
     loan from).
   - **Request Date**: defaults to today's date. Change if needed.
   - **Loan Type**: select a loan type with **Direction** set to **In**.
   - **Loan Amount**: fill in the principal amount to be received.
