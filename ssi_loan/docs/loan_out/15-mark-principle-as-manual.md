...
- The **Payment Schedule** line's **Principle Payment State** is not already
  **Manually Control**.
...
4. In the **Payment Schedule** table, click the icon button (tooltip: **Mark as
   Manually Control**) on the line to mark.
