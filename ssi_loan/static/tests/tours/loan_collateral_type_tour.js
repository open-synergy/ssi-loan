odoo.define("ssi_loan.loan_collateral_type_tour", function (require) {
    ...
    tour.register(
        "ssi_loan_loan_collateral_type_edit",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // ── Flow 2 — Find and open the record to edit
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Loan Collateral Type Edit) .o_data_cell:first",
                extra_trigger: ".o_list_view",
            },
            {
            ...
            // ── Flow 3 — Change the required fields
            {
                ...
                trigger: ".o_field_widget[name='name']",
                run: "text TOUR Loan Collateral Type Edit Changed",
            },
            ...
            // values
            {
                ...
                trigger:
                    ".o_control_panel .breadcrumb-item.active:contains(TOUR Loan Collateral Type Edit Changed)",
    ...
    tour.register(
        "ssi_loan_loan_collateral_type_delete",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // checkbox)
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Loan Collateral Type Delete) .o_list_record_selector input",
                run: "click",
            },
            ...
            // removed from the system
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Loan Collateral Type Delete)))",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
    ...
    tour.register(
        "ssi_loan_loan_collateral_type_deactivate",
        {
            test: true,
            url: "/web",
        },
        [
            ...
            // the checkbox)
            {
                content: "Select the record's checkbox",
                trigger:
                    ".o_data_row:contains(TOUR Loan Collateral Type Deactivate) .o_list_record_selector input",
                run: "click",
            },
            ...
            // appear in the default list view
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Loan Collateral Type Deactivate)))",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
    ...
    tour.register(
        ...
        [
            ...
            // the checkbox)
            {
                ...
                trigger:
                    ".o_data_row:contains(TOUR Loan Collateral Type Activate) .o_list_record_selector input",
                run: "click",
            },
            ...
            // ssi_loan's loan_type_tour.js, tour
            ...
            // gate.
            {
                ...
                trigger:
                    ".o_list_view:not(:has(.o_data_row:contains(TOUR Loan Collateral Type Activate)))",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
            ...
            },
            {
                ...
                trigger: ".o_data_row:contains(TOUR Loan Collateral Type Activate)",
                run: function () {
                    // Assertion only; do not trigger the default click action.
                },
            },
