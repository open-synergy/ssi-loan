...
>
> **Extends:** ssi_loan — model `loan.in`, aksi `01-create`
...
- **Operating Unit**: the operating unit that owns this incoming loan document. Not
...
- The **Loans In** list is filtered by operating unit (record rule). A user only sees
  incoming loan documents whose Operating Unit is one of the operating units assigned to
