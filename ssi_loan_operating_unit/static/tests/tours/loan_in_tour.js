...
odoo.define("ssi_loan_operating_unit.loan_in_tour", function (require) {
    "use strict";
    ...
    // ssi_loan/docs/loan_in/01-create.md Flow steps 1-2 -- see skill
    ...
    tour.register(
        "ssi_loan_operating_unit_loan_in_create",
        {
            test: true,
            url: "/web",
        },
