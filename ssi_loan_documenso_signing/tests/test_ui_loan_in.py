...
class TestUiLoanIn(HttpSavepointCase):
    ...
    def setUp(self):
        ...
        ``ssi_loan.tests.test_ui_loan_in``.
        ...
        account_realization = self.env["account.account"].create(
            {
                "code": "TOURLID1",
                "name": "Tour Loan In Documenso Realization Account",
        ...
        account_rounding = self.env["account.account"].create(
            {
                "code": "TOURLID2",
                "name": "Tour Loan In Documenso Rounding Account",
        ...
        account_interest = self.env["account.account"].create(
            {
                "code": "TOURLID3",
                "name": "Tour Loan In Documenso Interest Account",
                "user_type_id": receivable_type.id,
                "reconcile": True,
            }
        )
        account_interest_income = self.env["account.account"].create(
            {
                "code": "TOURLID4",
                "name": "Tour Loan In Documenso Interest Income Account",
                "user_type_id": revenue_type.id,
            }
        )
        account_principle_short = self.env["account.account"].create(
            {
                "code": "TOURLID5",
                "name": "Tour Loan In Documenso Short-Term Principle Account",
                "user_type_id": receivable_type.id,
                "reconcile": True,
            }
        )
        account_principle_long = self.env["account.account"].create(
            {
                "code": "TOURLID6",
                "name": "Tour Loan In Documenso Long-Term Principle Account",
                "user_type_id": receivable_type.id,
                "reconcile": True,
            }
        )
        realization_journal = self.env["account.journal"].create(
            {
                "name": "Tour Loan In Documenso Realization Journal",
                "code": "TLIDJ1",
                "type": "general",
            }
        )
        interest_journal = self.env["account.journal"].create(
            {
                "name": "Tour Loan In Documenso Interest Journal",
                "code": "TLIDJ2",
                "type": "general",
            }
        )
        self.loan_type = self.env["loan.type"].create(
            {
                "name": "Tour Loan Type In Documenso",
                "code": "/",
                "direction": "in",
